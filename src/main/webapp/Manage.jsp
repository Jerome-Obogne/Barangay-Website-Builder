<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.entity.Post,com.entity.User ,com.database.Dao_View, java.util.*" %>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-dark text-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush List-data">
                ...
                <a href="ManagePost" class="list-group-item list-group-item-action bg-transparent fw-bold active " data-bs-toggle="collapse" data-bs-target="#demo">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h3 class="post-text">MANAGE POST VIEW</h3>
					...
					<p class="bg-success p-2 text-white">${msg_update}</p>
					<%
                ...
                <div class="form-container">
                    ...
                    <div class="table-responsive">
					   ...
					   <%
					   	int count=0;
					   Dao_View viewPost=new Dao_View();
					   	 List<Post> list=viewPost.viewAllPost();	
					   %>
							...
							%>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="formBtn">
                                            <a href="<%=request.getContextPath() %>/Controller_ViewOnly?id=<%=post.getPost_id() %>" class="btn btn-sm btn-primary">View</a>
                                            <a href="Admin-editpost?id=<%=post.getPost_id() %>" class="btn btn-sm btn-success">Edit</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Confirm Archive Post </h5>
                    <button type="button"  class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="<%=request.getContextPath() %>/Controller_Delete" method="post">
