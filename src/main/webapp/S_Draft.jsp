<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.entity.Post, com.entity.User , com.database.Dao_Draft, java.util.*" %>
<!DOCTYPE html>
<html lang="en">
            ...
            <div class="container-fluid">
                ...
                <div class="form-container">
                    ...
                    <div class="table-responsive">
					   ...
					   <%
					   	int count=0;
					   Dao_Draft draftPost=new Dao_Draft();
					   	 List<Post> list=draftPost.getAllDraft();	
					   %>
                        <table class="table table-striped table-image">
                            ...
                            <tbody>
                                <tr>
                                    ...
                                    <td style="display: none;"><%=draft.getPost_id() %></td>
                                    ...
                                    <td>
                                        ...
                                        <div class="formBtn">
                                            ...
                                            <a href="Admin-editdraft?id=<%=draft.getPost_id() %>" class="btn btn-sm btn-success">Edit</a>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Confirm Archive Draft </h5>
                    <button type="button"  class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="<%=request.getContextPath() %>/Controller_DraftDelete" method="post">
