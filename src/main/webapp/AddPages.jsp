    ...
    <div class="d-flex " id="wrapper">
        ...
        <div class="bg-dark text-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush List-data">
                ...
                <a href="Admin-managepost" class="list-group-item list-group-item-action bg-transparent fw-bold" data-bs-toggle="collapse" data-bs-target="#demo">
                ...
                <a href="Admin-categories" class="list-group-item list-group-item-action bg-transparent fw-bold">
                  ...
                  <a href="Admin-Page" class="list-group-item list-group-item-action bg-transparent fw-bold active" data-bs-toggle="collapse" data-bs-target="#demo2">
                    <i class="fa-solid fa-table-columns"></i>Pages <i class="fa-solid fa-caret-down"></i>
                </a>
                
                <ul class="postNav navbar-nav  collapse" id="demo2">
                
                    <li class="nav-item">
                        <a href="Admin-Page" class="nav-link">All Pages</a>
                    </li>
                    
                    <li class="nav-item">
                        <a href="Admin-addpage" class="nav-link">Add Page</a>
                    </li>
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h3 class="post-text">Add New Page</h3>
                <div class="form-container">


					<%
					if (request.getSession().getAttribute("addPageMsg") != null) {
					%>

				     <p class="bg-danger p-2 text-white">${addPageMsg}</p>
					<%
					request.getSession().removeAttribute("addPageMsg");
								}
						else if (request.getSession().getAttribute("addPageMsg1") != null) {
					%>
					
					<p class="bg-success p-2 text-white">${addPageMsg1}</p>

					<%
					request.getSession().removeAttribute("addPageMsg1");}
					%>

					
                    <form action="Controller_Pages" method="post" enctype="multipart/form-data" class="row">
                    
                    
                    
                     <input type="hidden" name="user_id" placeholder="User_ID" value="<%=user.getUserId()%>">
                    	<input type="hidden" name="author" placeholder="Author Name" value="<%=user.getLastName()  %>">
                    	<input type="hidden" name="name" placeholder="Author Name" value="<%=user.getFirstName()  %>">
                    		<input type="hidden" name="role" placeholder="Author Name" value="<%=user.getRole() %>">
                        ...
                        <div class="col-lg-6 col-md mb-3">
                            ...
                            <input type="text" name="pageTitle" placeholder="Enter Page Title" class="form-control">
                        </div>
                        ...
                        <div class="col-lg-12 mb-3">
                            ...
                            <textarea name="content" id="editor" cols="30" rows="10" class="form-control" value="asdadadada">
                        ...
                        <div>
                            <button type="submit" class="btn btn-sm btn-dark" name="addPages" value="addpages">Submit</button>
