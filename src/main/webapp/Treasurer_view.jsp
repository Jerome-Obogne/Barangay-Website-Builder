...
<%List<Secretary_Post> list=(List) request.getSession().getAttribute("treasurer-view");

for(Secretary_Post post:list){
%>
        <div class="col-xxl-12 col-xl-12 col-lg-12  viewBackground rounded-2" id="mainImage" data-postBackground="<%=post.getPost_image() %>">
        ...
        <div class="content-view mt-3 text-break">
            ...
            <div class="article-sub text-muted mb-5">
                ...
                <span><i class="fa-regular fa-calendar-days"></i><%=post.getUpdated()  %></span>
            </div>
