<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
    ...
    <%@ page import="com.entity.Menu, com.entity.User ,com.database.Dao_Menu, java.util.*" %>
<!DOCTYPE html>
<html lang="en">
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-dark text-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush List-data">
                ...
                <a href="ManagePost" class="list-group-item list-group-item-action bg-transparent fw-bold" data-bs-toggle="collapse" data-bs-target="#demo">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h3 class="post-text">PAGE POST VIEW</h3>
			
			
			  
                	<%
					if (request.getSession().getAttribute("editPageMsg") != null) {
					%>

				 	<p class="bg-success p-2 text-white">${editPageMsg}</p> 
					<%
					request.getSession().removeAttribute("editPageMsg");
								}
                ...
                <div class="form-container">
                    <div class="table-responsive">
                      ...
                      <%
					   	int count=0;
					   Dao_Menu viewPages=new Dao_Menu();
					   	 List<Menu> list=viewPages.manageMenu();	
					   %>
						...
						<% for(Menu menu:list){
							...
							%>
                               <tr>
                                    ...
                                    <td style="display: none;"><%=menu.getMenu_images() %></td>
                                    <td><%=menu.getMenuAuthor()  %></td>
                                    <td><%=menu.getMenuTitle() %></td>
                                    <td><%=menu.getMenu_create() %></td>
                                    <td>

                                        <div class="formBtn">
                                            <a href="Controller_PageView?id=<%=menu.getMenuId() %>" class="btn btn-sm btn-primary">View</a>
                                            <a href="Admin-editpage?id=<%=menu.getMenuId() %>" class="btn btn-sm btn-success">Edit</a>
                                      <%--   <a href="Controller_Delete?id=<%=post.getPost_id() %>" type="button" class="btn btn-sm btn-danger">Del</a> --%>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Confirm Archive Page </h5>
                    <button type="button"  class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="<%=request.getContextPath() %>/Controller_PageDelete" method="post">
