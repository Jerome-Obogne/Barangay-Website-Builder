    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h3 class="post-text">Add User</h3>
                ...
                <div class="form-container">
                    ...
                    <form action="Controller_AddUser" method="post" id="addForm">
               ...
               <!-- Audit trail of Data  End here -->
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-6">
                                <input type="text" class="form-control" id="" name="username" autofocus>
                            </div>
                        </div>
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-6">
                                <input type=text  id="" placeholder="" class="form-control" name="email">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-6">
                                <input type="text"  id="" placeholder="" class="form-control" name="firstName">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-6">
                                <input type="text"  id="" placeholder="" class="form-control" name="lastName">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-6">
                                <input type="text"  id="" placeholder="Calatagan, Virac Catanduanes" class="form-control" name="address">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-6">
                                ...
                                <input type="date"  id="" class="form-control" name="dob">
                        ...
                        <div class="row mb-3">
                            ...
                            <div class="col-lg-6 password-toggle">
                          <!--    <div id="toggle1"></div> -->
                        ...
                        <div class="row mb-3">
							...
							<input type="hidden" name="status" value="Enable" placeholder="User Status">
                        </div>
		        ...
		        $.ajax({
		            ...
		            switch(data.toLowerCase()){
		            	...
		            	case 'passlength':
		            		...
		            		alert(' Password:8 Characters or More');
		            		 $(".formMessages2").show();
		            	...
		            	case 'passregex':
		            		...
		            		alert('Need to contain special characters and Letters and numbers');
		            		$(".formMessages2").show();
		            	...
		            	case 'validemail':
		            		...
		            		alert('Need Valid email');
		            		 $(".formMessages2").show();
			            	 $(".formMessages2").text("Need Valid email");
			            	 setTimeout(function() { $(".formMessages2").hide(); }, 5000);
		                	break; 	
		            	...
		            	case 'email':
		            		...
		            		alert('Email already exist');
		            		 $(".formMessages2").show();
			            	 $(".formMessages2").text("Email already exist");
			            	 setTimeout(function() { $(".formMessages2").hide(); }, 5000);
		                	break; 	
		            	...
		            	case 'username':
		            		...
		            		alert('Username already exist');
		            		 $(".formMessages2").show();
			            	 $(".formMessages2").text("Username already exist");
			            	 setTimeout(function() { $(".formMessages2").hide(); }, 5000);
		                	break; 
		              	...
		              	case 'success':
		            		...
		            		alert('Create Account Succesfully');
		            		 $(".formMessages1").show();
			            	 $(".formMessages1").text("Create Account Succesfully");
