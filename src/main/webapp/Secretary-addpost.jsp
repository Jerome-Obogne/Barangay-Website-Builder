    ...
    <div class="d-flex " id="wrapper">
        ...
        <div class="bg-dark text-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush List-data">
              ...
              <a href="Secretary-managepost" class="list-group-item list-group-item-action bg-transparent fw-bold active" data-bs-toggle="collapse" data-bs-target="#demo2">
                ...
                <a href="Secretary-draft" class="list-group-item list-group-item-action bg-transparent fw-bold">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h3 class="post-text">Add New Post</h3>
                <div class="form-container">


					<%
					if (request.getSession().getAttribute("insertMsg") != null) {
					%>

					<p class="bg-danger p-2 text-white">${insertMsg}</p>
					<%
					request.getSession().removeAttribute("insertMsg");
								}
						else if (request.getSession().getAttribute("insertMsg2") != null) {
					%>
					
					<p class="bg-success p-2 text-white">${insertMsg2}</p>

					<%
					request.getSession().removeAttribute("insertMsg2");}
					%>

					<form action="<%=request.getContextPath() %>/Controller_Secretary_Insert" method="post" enctype="multipart/form-data" class="row">
                      ...
                      <input type="hidden" name="user_id" placeholder="User_ID" value="<%=user.getUserId()%>">
                        ...
                        <div class="col-lg-6 col-md mb-3">
                           ...
                           <%List<Category> list=categories.categoryList(); %>
                        ...
                        <div>
                            <button type="submit" class="btn btn-sm btn-dark " name="addpost" value="review">Submit</button>
							 <button type="submit" class="btn btn-sm btn-danger" name="addpost" value="draft">Draft</button>
