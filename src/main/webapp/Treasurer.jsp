    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-dark text-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush List-data">
                ...
                <a href="Treasurer" class="list-group-item list-group-item-action bg-transparent second-text active">
                    <i class="fa-solid fa-gauge"></i>Dashboard
                </a>
                <a href="Treasurer-managepost" class="list-group-item list-group-item-action bg-transparent fw-bold">
        ...
        <div id="page-content-wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h3 class=" m-0">Treasurer Panel</h3>
                </div>
