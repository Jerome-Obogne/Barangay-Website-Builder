...
<%--
int total;
Dao_PostConcerns numberofConcerns=new Dao_PostConcerns();

total=numberofConcerns.totalNumberofConcerns();
--%>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div id="page-content-wrapper">
           ...
           <div class="container-fluid">
                ...
                <h3 class="post-text">Messages</h3>

                <!-- Form Container Starts Here -->
                <div class="form-container">

					<%
					if (request.getSession().getAttribute("messageRep1") != null) {
					%>

					<p class="bg-success p-2 text-white">${messageRep1}</p>

					<%
					request.getSession().removeAttribute("messageRep1");
					}
					%>
					...
					<p class="bg-success p-2 text-white">${deleteMsg}</p>
                    ...
                    <div class="table-responsive">
						...
						<% Dao_PostConcerns execution = new Dao_PostConcerns();
							...
							List<Concern> list= execution.getConcerns();
						...
						<table class="table table-striped">
                            ...
                            <tbody>
								...
								for (Concern concern : list) {
									messageid=concern.getMessageId();
								%>

								<tr>

                                    <td><%=concern.getName() %></td>
                                    <td><%=concern.getEmail() %></td>
                                    <td class="textContent">
                                       <%=concern.getMessage() %>
                                    </td>
                                    <td><%=concern.getDateTime() %></td>
                                    <td>

                                        <div class="formBtn">

                                            <a href="Controller_ViewConcern?id=<%=concern.getMessageId() %>" class="btn btn-sm btn-success">View</a>
                                            <a href="Admin-MessagePage?id=<%=concern.getMessageId() %>" class="btn btn-sm btn-primary">Reply</a>
                                            <a href="#"  class="btn btn-sm btn-secondary deleteBtn">Archive</a>
                                        </div>
                                    </td>
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                <div class="modal-header">
                    <h5 class="modal-title" id="exampleModalLabel"> Confirm Archive Message</h5>
                    <button type="button"  class="btn-close" data-bs-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                    </button>
                </div>

                <form action="<%=request.getContextPath() %>/Controller_PostConcerns2" method="post">

                    <div class="modal-body">

                        <input type="hidden" name="delete_id" id="delete_id" value="<%=messageid%>">
               ...
               <!-- Audit trail of Data  End here -->
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-default" data-bs-dismiss="modal">Cancel</button>
                           <input type="hidden" name="messageAction" value="messageDelete">
 ...
 <!-- DELETE OPERATION STARTS HERE -->
  ...
  <!-- DELETE OPERATION ENDS HERE -->
	 ...
	 for (const trimData of data) {
	     ...
	     trimData.textContent = text.slice(0,60)+ '...';
