                                ...
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <div class="formBtn">
                                            ...
                                            <a href="Treasurer-EditDraft?id=<%=draft.getPostId()  %>" class="btn btn-sm btn-success">Edit</a>
...
<div class="modal fade" id="deletemodal" tabindex="-1" role="dialog" aria-labelledby="exampleModalLabel"
        ...
        <div class="modal-dialog" role="document">
            <div class="modal-content">
                ...
                <form action="<%=request.getContextPath() %>/Controller_TreasurerDelete" method="post">
