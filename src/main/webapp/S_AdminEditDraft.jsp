        ...
        <div class="bg-dark text-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush List-data">
                ...
                <ul class="postNav navbar-nav  collapse" id="demo">
					...
					<li class="nav-item"><a href="S_ConfirmPost.jsp"
						class="nav-link">Confirm Post</a></li>
                ...
                <a href="Admin-draft" class="list-group-item list-group-item-action bg-transparent fw-bold active">
...
Post draft=execution.getDraftData(id);
...
%>
                ...
                <div class="form-container">
					...
					<form action="<%=request.getContextPath() %>/Controller_UpdateDraft" method="post" enctype="multipart/form-data" class="row">
                    
                    <input type="hidden" name="postId" placeholder="postID" value="<%=draft.getPost_id()  %>">
              ...
              <!-- Audit trail of Data  Start here -->
               ...
               <!-- Audit trail of Data  End here -->
                        ...
                        <div class="col-lg-6 col-md mb-3">
                            ...
                            <div class="cover-image my-3"> <img src="http://localhost:8080/CmsUploadImage/<%=draft.getPost_image()%>" alt="" class="img-fluid"></div>
                        ...
                        <div class="col-lg-6 col-md mb-3">
                            ...
                            <option value="Draft"><%=draft.getPost_status() %></option>
                            
                            <% if (draft.getPost_status().equals("Draft")) { %>
