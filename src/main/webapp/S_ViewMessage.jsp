           ...
           <div class="container-fluid">
                ...
                <div class="form-container">
					...
					<%
						...
						Concern UserConcerns = (Concern)request.getSession().getAttribute("userConcern");
					%>
					...
					<div class="Loginform-container">
						<form action="" method="post">
  							...
  							<div class="mb-3">
                                ...
                                <input type="text" class="form-control" name="name" value="<%=UserConcerns.getName()  %>" readonly>
                                <input type="hidden" name="messsageId" value="<%=UserConcerns.getMessageId() %>" placeholder="messageId">

                            </div>

                            <div class="mb-3">
                                <label for="" class="form-label">Email</label>
                                <input type="text" class="form-control" name="email" value="<%=UserConcerns.getEmail() %>" readonly>


                            </div>
                            <div class="mb-3">
                                <label for="" class="form-label">Message</label>
                                <textarea name="message" id="" cols="30" rows="10" class="form-control" readonly><%=UserConcerns.getMessage() %>
                                </textarea>
