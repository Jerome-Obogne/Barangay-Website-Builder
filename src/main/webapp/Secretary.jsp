<%@ page language="java" contentType="text/html; charset=ISO-8859-1"
   ...
   <%@ page errorPage="error.jsp"%>
    <%@ page import="com.entity.*,com.database.Dao_View, com.database.Dao_PostConcerns" %>
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-dark text-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush List-data">
                ...
                <a href="Secretary" class="list-group-item list-group-item-action bg-transparent second-text active">
                    <i class="fa-solid fa-gauge"></i>Dashboard
                </a>
                <a href="Secretary-managepost" class="list-group-item list-group-item-action bg-transparent fw-bold">
        ...
        <div id="page-content-wrapper">
            ...
            <nav class="navbar navbar-expand-lg navbar-light bg-transparent py-4 px-4">
                <div class="d-flex align-items-center">
                    ...
                    <h3 class=" m-0">Secretary Panel</h3>
                </div>
		...
		<script src="<%=request.getContextPath()%>/js/external.js"></script></body>
