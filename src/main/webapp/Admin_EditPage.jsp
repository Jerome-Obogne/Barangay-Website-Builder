	...
	<div class="d-flex " id="wrapper">
        ...
        <div id="page-content-wrapper">
            ...
            <div class="container-fluid">
                ...
                <h3 class="post-text">Edit Page</h3>
                <div class="form-container">
					...
					<p class="bg-danger p-2 text-white">${editPageMsg}</p> 
					<%
...
if (request.getParameter("id")==null || request.getParameter("id").equals("")){
	...
	request.getSession().setAttribute("BadRequest", "BadRequest");
...
<%}
	...
	Menu menu=execution.getPageData(id);

%>		
                    <form action="<%=request.getContextPath() %>/Controller_Pages" method="post" enctype="multipart/form-data" class="row">
                    
                    <input type="hidden" name="menuId" placeholder="postID" value="<%=menu.getMenuId() %>">
              ...
              <!-- Audit trail of Data  Start here -->
               ...
               <!-- Audit trail of Data  End here -->
                        ...
                        <div class="col-lg-6 col-md mb-3">
                            ...
                            <input type="text" name="menuTitle" placeholder="Enter Post Title" class="form-control" value="<%=menu.getMenuTitle() %>">
                        </div>
                        ...
                        <div class="col-lg-6 col-md mb-3">
                            ...
                            <%if (menu.getMenu_images()==null || menu.getMenu_images().equals("") ){ %>
                            
                                
                            <input type="file" name="file" id="" class="form-control">
                             <input type="hidden" name="oldfile" id="" class="form-control" value="">
                            <%} 
                            else {%>
                            <div class="cover-image"> <img src="http://localhost:8080/CmsUploadImage/<%=menu.getMenu_images() %>" alt="" class="img-fluid mb-3"></div>
                             <input type="hidden" name="oldfile" id="" class="form-control" value="<%=menu.getMenu_images() %>">
                             <input type="file" name="file" id="" class="form-control">
                        ...
                        <div>
                            <button type="submit" class="btn btn-sm btn-dark" name="addPages" value="updatepages">Submit</button>
