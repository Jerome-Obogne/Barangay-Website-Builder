    ...
    <div class="container-fluid">
        ...
        <div class="Loginform-container">
            ...
            <div class="text-center">
                ...
                <img src="image/logo6.png" alt="Sign in Image" class="img-fluid rounded-circle">
                <h3>Sign In</h3>

		   <% if(request.getSession().getAttribute("msgResetPass")!=null){ %>
               	   
               	   	<p class="text-success text-center">${msgResetPass}</p>
            ...
            <form action="<%=request.getContextPath() %>/Controller_Login" method="post" class="LoginForm">
                ...
                <div class="col-xxl-12 col-xl-12 col-lg-12 mb-3 password-toggle">
                    <div id="toggle"></div>
