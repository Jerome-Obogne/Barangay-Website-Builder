...
Post unpublish=execution.getUnpublishData(id);

int catId=unpublish.getPostCat_id();
%>
                ...
                <div class="form-container">
                    ...
                    <form action="<%=request.getContextPath() %>/Controller_UpdateConfirmPost" method="post" enctype="multipart/form-data" class="row">
                    
                    <input type="hidden" name="postId" placeholder="postID" value="<%=unpublish.getPost_id()  %>">
                       <%--	<input type="hidden" name="author" placeholder="Author Name" value="<%=user.getLastName()  %>"> --%>
                        <div class="col-lg-6 col-md mb-3">
                            <label for="" class="form-label">Post Title</label>
                            <input type="text" name="postTitle" placeholder="Enter Post Title" class="form-control" value="<%=unpublish.getPost_title() %>">
                        </div>
                        ...
                        <div class="col-lg-6 col-md mb-3">
                            ...
                            <option value=<%=unpublish.getPostCat_id() %>><%=unpublish.getCategoryName() %></option>
                        ...
                        <div class="col-lg-6 col-md mb-3">
                            ...
                            <div class="cover-image"> <img src="http://localhost:8080/CmsUploadImage/<%=unpublish.getPost_image()%>" alt="" class="img-fluid"></div>
                            
                            <input type="file" name="file" id="" class="form-control">
                              <input type="hidden" name="oldfile" id="" class="form-control" value="<%=unpublish.getPost_image()  %>">
                        </div>
                        ...
                        <div class="col-lg-6 col-md mb-3">
                            ...
                            <option value="Unpublish"><%=unpublish.getPost_status() %></option>
                            
                            <% if (unpublish.getPost_status().equals("Unpublish")) { %>
