...
<% User user=(User)session.getAttribute("secretaryData");%>	 <!-- User data using session -->
    ...
    <div class="d-flex" id="wrapper">
        ...
        <div class="bg-dark text-white" id="sidebar-wrapper">
            ...
            <div class="list-group list-group-flush List-data">
                ...
                <a href="Secretary-managepost" class="list-group-item list-group-item-action bg-transparent fw-bold active " data-bs-toggle="collapse" data-bs-target="#demo">
                                ...
                                <tr>
                                  ...
                                  <td><img src="http://localhost:8080/CmsUploadImage/<%=post.getPost_image() %>" alt="Cover Image"  class="img-fluid img-thumbnail"> </td>
                                    ...
                                    <td>
                                        ...
                                        <div class="formBtn">
                                            <a href="Controller_Secretary_ViewOnly?id=<%=post.getPostId() %>" class="btn btn-sm btn-primary">View</a>
