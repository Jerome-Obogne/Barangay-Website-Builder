...
<span class="navbar-toggler-icon"></span>
                ...
                <div class="collapse navbar-collapse" id="navigation">
                    <ul class="navbar-nav">
                        ...
                        <li class="nav-item">
                            <a href="Menu.jsp?id=<%=listofMenu.getMenuId() %>" class="nav-link"><%=listofMenu.getMenuTitle() %></a>
                        </li>
...
Dao_Menu menu=new Dao_Menu();
List<Menu> list=menu.viewOnlyPage(Integer.parseInt(request.getParameter("id")));
